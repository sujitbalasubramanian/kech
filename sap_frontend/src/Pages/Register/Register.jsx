        ...
        <div className="xl:w-2/4 w-full h-full flex flex-col px-8 ">
          <form action="" className="flex flex-col h-40 my-4 justify-between">
            ...
            <div className="relative">
              ...
              <input type="password" placeholder="Confrim Passward" className="w-full mb-2  h-2/12 p-2 border-2 border-neutral-200 rounded-sm hover:border-gray-300" required />
            </form>
          </div>
        </div>
